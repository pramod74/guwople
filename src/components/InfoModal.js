    ...
    <div className={`h-full ${darkMode ? 'dark' : ''}`}>
      ...
      <div className="h-full flex flex-col items-center justify-center max-w-[390px] mx-auto pt-9 text-primary dark:text-primary-dark">
          ...
          <ul className="list-disc pl-5 block sm:text-base text-sm">
            <li className="mt-6 mb-2">This is a word guessing game that selects words from a lexicon composed of words from <a href="https://twitter.com/gucci1017">the trap god Gucci Mane</a>'s track names. It's built on <a href="https://twitter.com/katherinecodes">Katherine Peterson</a>'s <a href="https://octokatherine.github.io/word-master">WordMaster</a></li>
          </ul>
          <ul className="list-disc pl-5 block sm:text-base text-sm">
